...
<html lang="en">
<head>
  <title>Scolarship Members List</title>
  <meta charset="utf-8">
...
<div class="container mt-5 pt-5"id="bck-image">
  <h2 class="mt-5 pt-5">Lista e aplikanteve te burses</h2>
  <table class="table table-condensed">
    ...
    <tbody>
        @foreach ($scolarship_members as $scolarship_member)
            <tr>
                <td>{{ $scolarship_member['name'] }}</td>
                <td>{{ $scolarship_member['surname'] }}</td>
                <td>{{ $scolarship_member['email'] }}</td>
                <td>{{ $scolarship_member['phone'] }}</td>
                <td>{{ $scolarship_member['school'] }}</td>
                <td>{{ $scolarship_member['average'] }}</td>
                <td>
                @if ($scolarship_member['average'] == '9.6 - 10.0')
                    50% 
                @elseif ($scolarship_member['average'] == '9.1 - 9.5')
                    25%
                @else
                    0%
                @endif
                ...
                <td>
                  <a class="btn btn-danger" href="{{ 'delete/'.$scolarship_member['id'] }}" role="button">Delete</a>
                  <a class="btn btn-warning" href="{{ 'editScolarshipMember/'.$scolarship_member['id'] }}" role="button">Edit</a>
              </td>
            </tr> 
        @endforeach
    </tbody>
