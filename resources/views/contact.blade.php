...
{{-- =============  PARALLAX ============ --}}
  <div class="parallax img-fluid col-md-12" data-parallax="scroll" data-z-index="1" data-image-src="{{ asset('image/contact.jpg') }}">
    <div class="">
  ...
  <div class="container py-4 text-center">
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold"style="font-size:5vw;color:rgb(0, 46, 91);">Kontaktoni</h1>
        ...
        {{-- <a href="{{ url('/scolarship_form') }}"><button class="btn btn-primary btn-lg" type="button"></button></a> --}}
      </div>
    </div>
  </div>
