...
{{-- =============  PARALLAX ============ --}}
  <div class="parallax img-fluid col-md-12" data-parallax="scroll" data-z-index="1" data-image-src="{{ asset('image/learn.jpg') }}">
    <div class="">
...
<div class="container py-4 text-center">
  <div class="p-5 mb-4 bg-light rounded-3">
    <div class="container-fluid py-5">
      <h1 class="display-5 fw-bold"style="font-size:5vw;color:rgb(0, 46, 91);">Shkolle Verore</h1>
      ...
      <a href="{{ url('/summerSchool_form') }}"><button class="btn btn-primary btn-lg" type="button">Apliko tani</button></a>
    </div>
  </div>
</div> 

<div class="parallax img-fluid col-md-12" data-parallax="scroll" data-z-index="1" data-image-src="{{ asset('image/summer1.jpg') }}">
  <div class="">
    <h5 class="info text-light text-center pt-5 fs-1"></h5>
  </div>
</div>
...
<div class="row align-items-md-stretch">
  <img src="{{ asset('image/learn1.jpg') }}"class="col-md-6"style="height:30rem;" alt="">
  <div class="col-md-6">
